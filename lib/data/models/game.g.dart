      ...
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(
                BuiltList, const [const FullType(PlatformObject)])));
    }
...
class _$GameResult extends GameResult {
  ...
  _$GameResult._({required this.games}) : super._() {
    BuiltValueNullFieldError.checkNotNull(games, r'GameResult', 'games');
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is GameResult && games == other.games;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GameResult')..add('games', games))
        .toString();
  }
}
...
class GameResultBuilder implements Builder<GameResult, GameResultBuilder> {
  ...
  _$GameResult _build() {
    ...
    try {
      _$result = _$v ?? new _$GameResult._(games: games.build());
    } catch (_) {
...
class _$Game extends Game {
  ...
  @override
  final BuiltList<PlatformObject>? platforms;
  @override
  final BuiltList<PlatformObject>? parentPlatforms;
  @override
...
class GameBuilder implements Builder<Game, GameBuilder> {
  ...
  ListBuilder<PlatformObject>? _platforms;
  ListBuilder<PlatformObject> get platforms =>
      _$this._platforms ??= new ListBuilder<PlatformObject>();
  set platforms(ListBuilder<PlatformObject>? platforms) =>
      _$this._platforms = platforms;

  ListBuilder<PlatformObject>? _parentPlatforms;
  ListBuilder<PlatformObject> get parentPlatforms =>
      _$this._parentPlatforms ??= new ListBuilder<PlatformObject>();
  set parentPlatforms(ListBuilder<PlatformObject>? parentPlatforms) =>
